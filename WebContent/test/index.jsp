...
<body>
    ...
    function process() {
    	...
    	$("#dua_data").load("<util:applicationRoot/>/test/dua_check.jsp?email="+inputValue.match(/@(.*)/)[1]);
    	$("#una_data").load("<util:applicationRoot/>/test/una_check.jsp?email="+inputValue.match(/@(.*)/)[1]);
    	return false;
    }
	</script>
